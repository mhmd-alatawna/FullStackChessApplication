...
// and injects it as HTTP headers required by the backend middleware.

const BASE_URL = "http://localhost:3000/api";

// Builds the four headers the backend expects for every authenticated request.
...
// Stateless logout — backend simply returns { success: true }.
...
// Fetch the logged-in user's editable settings (maps to GET /settings on the backend).
