...
> Legacy documentation: this describes the original `backend` directory and is retained only for
> historical comparison. The active contract is documented in
> [`backend_v2/README.md`](../../backend/README.md). Do not use the headers or routes below when
> integrating with backend v2.
